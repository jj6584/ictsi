...
<body class="nav-md">
 ...
 //$this->load->model_admin('get_faqs');
                        foreach ($faq as $key) {
                            echo "<tr>";
                            echo "<td>" . $key['id'] . "</td>";
                            echo "<td>".$key['question']."</td>";
                            echo "<td>".$key['answer']."</td>";
                            echo "<td>".$key['date_posted']."</td>";

                            echo "<td>  <a href=\"".base_url()."admin/view_update_FAQ/".$key['id']."\">
                            <span class='fa fa-pencil' aria-hidden='true' role='button'></span>
                            </a>
                             |
                            <a href=\"".base_url()."admin/delete_FAQS/".$key['id']."\">
                            <span class='fa fa-trash' aria-hidden='true' role='button'></span></a>
                            </td>";
            ...
            <center>
                <a class="btn btn-primary" href="<?php echo base_url();?>admin/add_FAQ" role="button">Create Frequently Asked Questions</a>
            </center>
