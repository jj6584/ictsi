...
<?php echo form_open('admin/update_footer');?>
<form>
  <div class="form-group">
    <label for="exampleInputEmail1">Copyright: </label>
    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $posts['copyright'];?>" name="copyright">
  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Links: </label>
    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $posts['fblink'];?>" name="fb"><br/>
    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $posts['twitterlink'];?>" name="twitter">
  </div>



       <button class="btn btn-primary pull-right" type="submit">Update Footer</button>
