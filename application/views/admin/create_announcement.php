...
<?php
    ...
    ?>
        ...
        <form action = "<?=base_url()?>admin/create_announcements" method="post" >
          <div class="form-group <?php if(form_error('title')){echo "has-error";}?>">
            <label for="title">Announcement Title: <small>(Optional)</small> </label>
            <input type="text" name="title" class="form-control" id="title" placeholder="Announcement Title" value="<?php echo set_value('title');?>">
          </div>
            <div class="form-group <?php if(form_error('announcement')){echo "has-error";}?>">
          <label for="announcement">Announcement:</label>
          <textarea class="form-control" rows="10" id="announcement" name="announcement"></textarea>
        </div>

            <a class="btn btn-default" href="<?php echo base_url();?>admin/manage_announcement"
                role="button">Back</a>
            <button class="btn btn-primary pull-right" type="submit">Create Announcement</button>
