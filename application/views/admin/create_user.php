...
<body class="nav-md">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
								<?php
                                    if(isset($_SESSION['adminsucc'])){
                                        echo $_SESSION['adminsucc'];
                                    }
                                ?>
 <div class="panel panel-primary banner-upload">
    ...
    ?>
      ...
      <select class="form-control" id="usertype" name="usertype">
        <option>Select Type</option>
         <option value="31">HR Administrator (HR assistant)</option>
  ...
  <div class="form-group <?php if(form_error('fname')){echo "has-error";}?>">
    ...
    <input type="txt" name="fname" class="form-control" id="fname" placeholder="First Name" value="<?php echo set_value('fname');?>">
  </div>

    <div class="form-group <?php if(form_error('mname')){echo "has-error";}?>">
    <label for="fname">Middle Name: </label>
    <input type="txt" name="mname" class="form-control" id="mname" placeholder="Middle Name" value="<?php echo set_value('mname');?>">
  </div>

  <div class="form-group <?php if(form_error('lname')){echo "has-error";}?>">
    <label for="lname">Last Name: </label>
    <input type="txt" name="lname" class="form-control" id="lname" placeholder="Last Name" value="<?php echo set_value('lname');?>">
  </div>

    <div class="form-group <?php if(form_error('empno')){echo "has-error";}?>">
    <label for="empno">Employee No / Username <small>(employee no. for HR admin, username for system admin)</small></label>
    <input type="txt" name="empno" class="form-control" id="empno" placeholder="Employee No. or username" value="<?php echo set_value('empno');?>">
  </div>
