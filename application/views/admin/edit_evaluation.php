...
<?php
    ...
    ?>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url();?>adminusers/<?php echo $foldername;?>/<?php echo $img1['profile_pic'];?>" alt=""><?php echo base_url();?>
        ...
        <?php
            ...
            $getedited = $this -> model_admin -> gettobeupdated($this->uri->segment(3));
...
<div class="panel panel-primary">
  <div class="panel-heading">
    ...
    <?php
        ...
        echo form_open('admin/doupdateEval');
        foreach ($getedited as $var) {
           
      
    ?>
    <div class="form-group">
  <label for="answer"><span class="fa fa-file-o" aria-hidden="true"></span>&nbsp;Evaluation Question:</label>
  <textarea class="form-control" rows="`0" name="eval" value="<?php echo $var['eval_question'];?>" id="answer" style="height: 10em;"><?php echo $var['eval_question'];?></textarea>
</div>
<?php
            echo form_hidden('hidden_id', $var['eval_id']);
            }
?>

    <a class="btn btn-default" href="<?php echo base_url();?>admin/manage_evaluation" role="button">Back</a>
