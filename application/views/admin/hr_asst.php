                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a><i class="fa fa-line-chart"></i>Performance Evalualtion &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Form<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li>
                                            <a href="<?php echo base_url();?>admin/hr_asst"><i class="fa fa-calendar"></i>Assigned Task</a>
                                        </li>
                            </ul>
                        </div>
                                ...
                                <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                                    <li>
                                        ...
                                        <img src="<?php echo base_url();?>images/admin/adminphoto.jpg" alt="Profile Image" />
                                            ...
                                            <span>
                                        <span><a href="<?php echo base_url();?>admin/see_all_alerts">John Smith<a></span>
                                            <span class="">3 mins ago</span>
                                            </span>
                                            <span class="message">
                                        have been responded for interview schedule <b>PERSONAL INTERVIEW</b>
                                    </span>
                                        </a>
                                    </li>
                                    <li>
...
<?php
    ...
    $datas  = $this -> model_admin -> get_todo3($_SESSION['admin_id']);
?>
                                            ...
                                            <ul class="list-unstyled timeline">
                                              <?php
                                                ...
                                                foreach ($datas as $data) {
                                                  $deadline =  $data['date'].$data['end_time'];
                                                  $id = $data['id'];
                                                  $newdeadline = date("F j, Y, g:i a", strtotime($deadline));
                                              ?>
                                    <li>
                                        <div class="block">
                                            ...
                                            <div class="block_content">
                                                ...
                                                <div class="byline">
                                                    <span>Deadline: <?php echo $newdeadline;?></span>
                                                </div>
                                                <p class="excerpt">
                                                ...
                                                ?>
                                                <a href="<?php echo base_url()?>admin/activitymarkasdone/<?php echo $id?>"> <button class="btn btn-primary"><span class="fa fa-check"></span> Mark as Done</button></a>
                                                  <?php
                                                }else{
                                                  ?>
                                                  <span class="fa fa-check label label-success"> Waiting for HR head to delete this activity.</span>
                                                  <?php
                                                }
                                                  ?>
                                            </div>
