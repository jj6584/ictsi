...
$id =  $this->uri->segment(3);
 $jobs = $this->model_admin->get_job_desc($id);
 ?>
...
<div class="panel-body">
        <?php echo form_open('admin/update_job/'.$id);?>
            ...
            <div class="form-group <?php if(form_error('job_title')){echo "has-error";}?>">
                ...
                <input type="text" class="form-control" id="jobTitle" placeholder="" value="<?php echo $jobdesc['job_title']?>" name="job_title">
            </div>

            <div class="form-group">
                <label for="jobTitle"><font face="caviar dreams" size="4%">Requisition ID:</font></label>
                <input type="text" class="form-control" id="jobTitle" value="<?php echo $jobdesc['job_requisition_id']?>" placeholder="Requisition ID" name="req_id">
            </div>

			 <div class="form-group">
                <label for="jobTitle"><font face="caviar dreams" size="4%">Job Slot:</font></label>
                <input type="text" class="form-control" id="jobTitle" value="<?php echo $jobdesc['job_slots']?>" placeholder="Requisition ID" name="job_slots">
            </div>
        ...
        <div class="form-group">
                ...
                <textarea placeholder="Job Description" class="form-control input-lg" rows="2" value="<?php echo $jobdesc['job_desc']?>" id="elm1" name="job_desc"><?php echo $jobdesc['job_desc']?></textarea>
        </div>



        <div class="form-group col-md-4">
                <label><font face="caviar dreams" size="4%">Qualifications:</font> </label>
                <select class="form-control" id="sel1" name="ha">
                      <option default selected value="<?php echo $jobdesc['highest_att']?>"><?php echo $jobdesc['highest_att']?></option>
       ...
       <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-12">
                <select class="select2_multiple form-control" multiple="multiple" name='skills'>
               <?php
                $skillz = $jobdesc['job_skills'] ;
                $SKILLS = explode(",", $skillz);

      foreach ($SKILLS as $skill) {

                         echo "<option default selected value='$skill' >$skill</option>";
    ...
    <br><br><br> <br><br><br><br><br>
        <div class="form-group col-md-4">
             <select class="form-control" id="sel1" name="program">
              <option default selected><?php echo $jobdesc['work_area']?></option>
...
<br><br>
        <div class="form-group col-md-4">
             <select class="form-control" id="sel1" name="emp_type">
              <option default selected value="<?php echo $jobdesc['employment_type']?>">Employment type : <?php echo $jobdesc['employment_type']?> </option>
...
<br><br>
        <label><font face="caviar dreams" size="4%">&nbsp;&nbsp;Work Experience:</font> </label><br>
         <div class="form-group manage_exp">

            <div class="col-md-2">

                <select class="form-control" id="sel1" name="number">
                <option default selected value="<?php echo $jobdesc['work_exp']?>"><?php echo $jobdesc['work_exp']?></option>
            ...
            <div class="col-md-2">
                <select class="form-control" id="sel1" name="year/month">
        ...
        <div class="form-group col-md-4">
            ...
            <select class="form-control" id="sel1" name="salary">
                <option default selected value ="<?php echo $jobdesc['exp_salary']?>">Salary: <?php echo $jobdesc['exp_salary']?></option>
...
<br><br><br><br><br>
         <a href="<?php echo base_url();?>admin/hr_editjob"><button class="btn btn-default" type="submit"><font face="bebas" size="4%">Cancel</font></button></a>
       <button class="btn btn-primary pull-right" type="submit"><font face="bebas" size="4%">Save Changes</font></button>
