...
<div class="box-ulit">
                ...
                <?php echo form_open('admin/addinterview');?>
                <?php
                $userid = $this->uri->segment(3);
                $jobid = $this->uri->segment(4);

                $this -> load ->model('model_admin');
                $val = $this->model_admin->getUserdetails($userid);
                ?>
                  ...
                  <div class="panel-body">
                        ...
                        <br>
                        <textarea class="form-control rows="4" cols="50" " name="rmk"></textarea>
                        <br>
                        <?php echo form_hidden('uid', $userid);?>
                        <?php echo form_hidden('jid', $jobid);?>
                        <center> <input class="btn btn-primary btn-lg" type="submit" role="button"></a>
