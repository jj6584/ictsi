              ...
              <option disabled selected>Program</option>
                    <option value="Information Technology,Computer Scince">Information Technology/Computer Science</option>
                      ...
                      <option value="Engineering,Mechanical">Engineering (Mechanical)</option>
                        ...
                        <option value="Human Resource,Human Resource Management">Human Resource Management</option>
...
<br><br>
		...
		<br><br><br><br>
		<div class="form-group col-md-4">
            <label><font face="caviar dreams" size="4%">Slots:</font> </label>
           <input type="text" class="form-control" id="job_slots" placeholder="Number of Slots" name="job_slots">
