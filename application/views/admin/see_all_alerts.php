                    ...
                    <nav class="" role="navigation">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <?php
                            ...
                            $getall = $this ->model_admin -> seeallalerts();
                          ?>
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>See all alerts<small>Notification</small></h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <li>
                                        <a>
                                            <span class="image">
                                    <!-- <img src="<?php echo base_url();?>adminusers/<?php echo $foldername;?>/<?php echo $img1['profile_pic'];?>" alt="img" /> -->
                                </span>
                                            <span>
                                    <span><?php echo $key['fname']." ". $key['lname'];?></span>
                                            <span class=""><?php echo $key['date_added'];?></span>
                                            </span>
                                            <span class="message">
                                              <?php
                                                echo $key['t_notification_desc'];
                                              ?>
                                                </span>
                                        </a>
                                    </li>
