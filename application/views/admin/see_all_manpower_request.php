    ...
    ?>
                    ...
                    <div class="profile">
                        <div class="profile_pic">
                            <img src="<?php echo base_url();?>images/admin/adminphoto.jpg" alt="..." class="img-circle profile_img">
                        </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo base_url();?>images/admin/adminphoto.jpg" alt=""><?php echo $fullname;?>
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>See All Manpower Request<small>Notification</small></h2>
                                ...
                                <?php
                                        ...
                                        foreach ($getmanpower as $getman) {

                                ?>
                                    <li>
                                        <a href="<?php echo base_url();?>admin/approvereq/<?php echo $getman['mp_id'];?>">
                                         <!--    <span class="image">
                                    <img src="<?php echo base_url();?>images/admin/adminphoto.jpg" alt="img" />
                                </span> -->
                                            <span>
                                    <font size="10em"><span><?php echo $getman['job_position'];?></span></font>

                                            </span><br>
                                    <span><?php echo "working experience:".$getman['work_expi']."yrs";?></span><br>
                                             <span><?php echo "employment type:".$getman['employment_type'];?></span>

                                            <span class="message">
                                                    <?php echo "Skills requirements:".$getman['skills_requirements'];?>
