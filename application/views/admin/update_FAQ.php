...
?>-->
<form action="<?=base_url()?>admin/update_FAQ/<?=$post['id']?>" method="post">
...
?>
  <div class="form-group">
    <label for="exampleInputEmail1"><span class="fa fa-question-circle" aria-hidden="true"></span>&nbsp;Question: </label>
    <input type="text" class="form-control" name="question" value="<?=$post['question']?>" id="exampleInputEmail1" placeholder="Example: Copyright <year>">
  </div>
    <div class="form-group">
  <label for="answer"><span class="fa fa-check" aria-hidden="true"></span>&nbsp;Answer:</label>
  <textarea class="form-control" rows="`0" name="answer" value="<?=$post['answer']?>" id="answer" ><?=$post['answer']?></textarea>
</div>

    <a class="btn btn-default" href="<?php echo base_url();?>admin/Manage_FAQ" role="button">Back</a>
    <button class="btn btn-primary pull-right" type="submit">Update FAQ</button>
