...
<?php
    ...
    <?php
        ...
        $getdetails = $this -> model_admin -> getappintev($this->uri->segment(3));
                                        ...
                                        <div class="media-body">
                                            <div class="interview-sched-box">
                                                ...
                                                ?>
                                                            <tr>
                                                            <td>
                                                            <font color='RED' size="5em"><b>INTERVIEW SCHEDULE SUMMARY</b></font>
                                                            <h4><b><?php echo $key['fname']." ".$key['lname'];?></b></h4>
                                                            <p><b>Time:</b> <?php echo $key['time'];?></p>
                                                            <p><b>Date:</b> <?php echo $key['int_date'];?></p>
                                                            <p><b>Type of Interview: <?php echo $type; ?></p>
                                                            <br>
                                                                    <?php
                                                                            if($key['response'] == 5){
                                                                    ?>
                                                                 <a href="skype:<?php echo $key['skypeuser'];?>?call&video=true"><button type="button" class="btn btn-primary "><font size="4em"><span class="fa fa-skype">  </font>  Call Applicant</span></button>
                                                                      <?php
                                                                        }
                                                                      ?>
