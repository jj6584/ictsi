...
<?php
    ...
    ?>
        ...
        <?php
           ...
           $thedetails =  $this->model_admin->viewquestionandans($this->uri->segment(3));
...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">View Evaluated Employees</h3>
  </div>
<div>
...
<?php
        foreach ($thedetails as $var) {


?>

    <table class='table  table-size table-pos' style="margin:0">
    <thead>

        <td align="center"><strong>Question</strong></td>
    </thead>
                <?php
                        $question = $this -> model_admin ->getQUESTIONS($var['perf_type']);
                        foreach ($question as $questions) {


                ?>
    <tr>
        <td><?php echo $questions['eval_question'];?></td>
    </tr>
    <?php
            }
    ?>
...
<br> <br>
    <a href="<?php echo base_url();?>admin/viewEvaluated"><button class="btn btn-primary">Back</button></a>
     <a href="<?php echo base_url();?>admin/removeeval/<?php echo $uriID;?>"><button class="btn btn-warning">Remove evaluation</button></a>
