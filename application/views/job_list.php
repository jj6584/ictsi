...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form action="<?php echo base_url();?>main/search_job" method="post">
  <div class="form-group">
  ...
  echo "<a data-toggle='collapse' href=#".$data['job_id'].">".$data['job_title']."</a>
      ...
      <div id=".$data['job_id']." class='panel-collapse collapse'>
       ...
       <div class='panel-body'>Employment Type: <br>".$data['employment_type']."</div>
        ...
        <div class='panel-footer'>".anchor('main/insertsavejobs/'.$data['job_id'].'',"<input type='button' class='btn btn-success' data-toggle='tooltip' value='Save Job' data-placement='right' title='Remove Jobright'") ." ".

        anchor('main/job_description/'.$data['job_id'].'',"<input type='button' class='btn btn-default' data-toggle='tooltip' value='See more description' data-placement='right' title='Remove Jobright'")
